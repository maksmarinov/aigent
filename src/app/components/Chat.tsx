...
export const Chat = ({ messages, isLoading = false, onStop }: ChatProps) => {
  ...
  return (
    ...
    >
      ...
      {isLoading && (
        <div className="relative mb-4 p-4 text-black rounded-md border-2 border-gray-500 bg-gray-400 text-left animate-pulse">
